// The page had no About section at all, which reads as an omission rather than a
// choice: it's where a reviewer gauges whether someone can explain their own work.
// This is the resume's professional summary rewritten as something a person would say,
// leading with the origin story because it's the part no other candidate has.
export const ABOUT = [
...
// resume — no rounded-up "10+ projects" filler, because a number a candidate can't
// defend in an interview costs more than it earns.
export const HIGHLIGHTS = [
  { value: "5+", label: "years building web systems" },
  { value: "~400", label: "employees served by the HRIS" },
  { value: "13+", label: "modules in that one system" },
  { value: "5", label: "certification processes digitized" },
];
